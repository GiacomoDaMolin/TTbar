...
#include "TH1.h"
    ...
    // add weighted histograms
    TH1D* h_Muon_Electron_invariant_mass_weighted = new TH1D("Muon_Electron_invariant_mass_weighted", "Muon_Electron_invariant_mass_weighted", 100, 0, 400);
    TH1D* h_Muon_Muon_invariant_mass_weighted = new TH1D("Muon_Muon_invariant_mass_weighted", "Muon_Muon_invariant_mass_weighted", 100, 0, 400);
    TH1D* h_Electron_Electron_invariant_mass_weighted = new TH1D("Electron_Electron_invariant_mass_weighted", "Electron_Electron_invariant_mass_weighted", 100, 0, 400);
